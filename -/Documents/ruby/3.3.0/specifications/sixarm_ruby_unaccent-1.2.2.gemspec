...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q(minitest).freeze, [ ">= 5.12".freeze, "< 6".freeze ])
  s.add_development_dependency(%q(sixarm_ruby_minitest_extensions).freeze, [ ">= 1.0.8".freeze, "< 2".freeze ])
  s.add_development_dependency(%q(rake).freeze, [ ">= 12.3.3".freeze, "< 13".freeze ])
  s.add_development_dependency(%q(simplecov).freeze, [ ">= 0.18.0".freeze, "< 2".freeze ])
end
