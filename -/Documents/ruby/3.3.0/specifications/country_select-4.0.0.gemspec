...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<wwtd>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<countries>.freeze, ["~> 3.0".freeze])
  s.add_runtime_dependency(%q<sort_alphabetical>.freeze, ["~> 1.0".freeze])
end
